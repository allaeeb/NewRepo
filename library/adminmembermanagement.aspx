<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="library.adminmembermanagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently" style="background-color: #183a1d;
        border-color: #5C3A1B;
        color: #fff;"
 />
                     </div>
